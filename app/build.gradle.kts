...
// "Carpeta schemas versionada y migración 1→2 registrada" de la guía.
room {
...
dependencies {
    ...
    // Persistencia local: Room (driver-based) + DataStore de preferencias
    ...
    // Red y Serialización: Retrofit + kotlinx.serialization
