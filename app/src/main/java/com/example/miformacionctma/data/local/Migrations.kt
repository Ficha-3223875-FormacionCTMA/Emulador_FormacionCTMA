...
val MIGRATION_3_4 = object : Migration(3, 4) {
    override fun migrate(connection: SQLiteConnection) {
        connection.execSQL("ALTER TABLE actividades ADD COLUMN evidenciaUri TEXT")
        connection.execSQL("ALTER TABLE actividades ADD COLUMN estadoEvidencia TEXT NOT NULL DEFAULT 'LOCAL'")
    }
}
